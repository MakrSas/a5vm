 ...
 * из scripts/compat/ios6-compat.c — собственную реализацию, потому что
 * armv7-срез из compiler-rt в современных Xcode убран.
 *
 * Ошибка в ней проявилась бы как «переменная внезапно нулевая» глубоко
