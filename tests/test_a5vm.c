...
static void test_i386_protected_mode(void) {
    ...
    static const uint8_t gdt[] = {
        ...
        0xFF, 0xFF, 0x00, 0x40, 0x00, 0x92, 0xCF, 0x00
    };
    ...
    static const uint8_t protected_code[] = {
        ...
        0xB9, 0x10, 0x00, 0x00, 0x00, /* mov ecx, data selector */
        0x8E, 0xD9,                   /* mov ds, cx */
        0x89, 0x05, 0x00, 0x00, 0x00, 0x00, /* mov [00000000], eax */
        0xF4
    };
    ...
    CHECK(a5vm_memory_read16(&memory, 0x4000) == 0x5679);
    CHECK(a5vm_memory_read16(&memory, 0x4002) == 0x1234);
}
